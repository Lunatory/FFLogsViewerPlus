...
public class Configuration : IPluginConfiguration
{
    ...
    private static List<LayoutEntry> GetDefaultLayout()
    {
        ...
        [
            ...
            new LayoutEntry { Type = LayoutEntryType.Encounter, Expansion = "Dawntrail", Zone = "ACC Heavyweight", ZoneId = 73, Encounter = "The Lindwurm II", EncounterId = 105, Difficulty = "Savage", DifficultyId = 101, SwapId = "7.4", SwapNumber = 0 },
